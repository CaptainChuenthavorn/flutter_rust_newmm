...
class RustLibWire implements BaseWire {
  ...
  late final _dart_fn_deliver_outputPtr = _lookup<
      ffi.NativeFunction<
          ffi.Void Function(ffi.Int32, ffi.Pointer<ffi.Uint8>, ffi.Int32,
              ffi.Int32)>>('frbgen_flutter_rust_newmm_dart_fn_deliver_output');
  late final _dart_fn_deliver_output = _dart_fn_deliver_outputPtr
      .asFunction<void Function(int, ffi.Pointer<ffi.Uint8>, int, int)>();

  WireSyncRust2DartDco wire_get_token(
  ...
  late final _wire_get_tokenPtr = _lookup<
      ...
      'frbgen_flutter_rust_newmm_wire_get_token');
  ...
  late final _wire_greetPtr = _lookup<
          ffi.NativeFunction<
              WireSyncRust2DartDco Function(
                  ffi.Pointer<wire_cst_list_prim_u_8_strict>)>>(
      'frbgen_flutter_rust_newmm_wire_greet');
  ...
  late final _wire_init_appPtr =
      _lookup<ffi.NativeFunction<ffi.Void Function(ffi.Int64)>>(
          'frbgen_flutter_rust_newmm_wire_init_app');
  ...
  late final _cst_new_list_StringPtr = _lookup<
      ffi.NativeFunction<
          ffi.Pointer<wire_cst_list_String> Function(
              ffi.Int32)>>('frbgen_flutter_rust_newmm_cst_new_list_String');
  ...
  late final _cst_new_list_prim_u_8_strictPtr = _lookup<
      ...
      'frbgen_flutter_rust_newmm_cst_new_list_prim_u_8_strict');
